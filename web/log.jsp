...
<html>
    ...
    <body>
    <div class="ex-page-content bootstrap snippets bootdeys" style="display: flex;
        ...
        <div class="row" style="display: flex">
            ...
            <div class="col-sm-6">
                <div class="message-box">
                    ...
                    <p>Login Server Error.</p>
                    <div class="buttons-con">
                        <div class="action-link-wrap">
                            <a href="admin.jsp" class="btn btn-custom btn-info waves-effect waves-light m-t-20">Go Back</a>
                            <a href="Home.jsp" class="btn btn-custom btn-info waves-effect waves-light m-t-20">Go to Home Page</a>
                        </div>
                    </div>
                </div>
            </div>
